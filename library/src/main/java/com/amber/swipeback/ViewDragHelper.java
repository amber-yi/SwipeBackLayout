...
/**
 * Created by luosiyi
 * Desc:  ViewDragHelper is a utility class for writing custom ViewGroups. It offers a
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.amber.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.amber.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.amber.swipeback.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link com.amber.swipeback.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
